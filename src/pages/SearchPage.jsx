...
export default function SearchPage() {
    ...
    return (
        <div className="p-4 min-h-screen bg-gray-900 text-white">
            <button
                onClick={() => navigate(-1)}
                className="mb-4 bg-purple-800 text-sm px-4 py-2 rounded hover:bg-purple-600"
            >
                ← Back
            </button>
            ...
            <form
                ...
                className="flex flex-col sm:flex-row gap-2 mb-6 max-w-xl mx-auto"
            >
                <input
                    type="text"
                    placeholder="Search movies or TV shows..."
                    className="flex-grow px-4 py-2 text-black rounded"
                    value={query}
                    onChange={(e) => setQuery(e.target.value)}
                />
                <button
                    type="submit"
                    className="bg-purple-800 px-4 py-2 rounded hover:bg-purple-600"
                >
                    Search
                </button>
            </form>
